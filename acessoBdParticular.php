...
$tabela = "SELECT * FROM controle WHERE particular = 'sim';";
...
$result_pacientes = "SELECT registro, nome, quantidade_fr, quantidade_fm, particular, DATE_FORMAT(data_cadastro, '%d-%m-%Y') as data_cadastroo, observacao FROM controle WHERE particular = 'sim' ORDER BY data_cadastro ASC LIMIT $inicio, $quantidade_pg;";
                                    ...
                                    <tbody>
                                        <?php while($linha = mysqli_fetch_assoc($resultado_pacientes)){ ?>
                                            <tr>
                                                ...
                                                <td><?php echo $linha['particular']; ?></td>
                                                <td><?php echo $linha['data_cadastroo']; ?></td>
                                                <td><?php echo $linha['observacao']; ?></td>
                                                <td><a href="editDadosParticular.php?registro=<?php echo $linha['registro']; ?> " class="btn btn-primary btn-sm" ">Editar</a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>      
                            ...
                            <ul class="pagination">
                                <?php
                                    if($pagina_anterior != 0){ ?>
                                       <li class="page-item"><a class="btn btn-primary btn-sm" href="acessoBdParticular.php?pagina=<?php echo $pagina_anterior; ?>">Anterior</a></li> 
                                    <?php }else{ ?>
                                ...
                                <li class="page-item"><a class="btn btn-primary btn-sm" href="acessoBdParticular.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>                                    
                                <?php } ?>
                                
                                <?php
                                    if($pagina_posterior <= $num_pagina){ ?>
                                       <li class="page-item"><a class="btn btn-primary btn-sm" href="acessoBdParticular.php?pagina=<?php echo $pagina_posterior; ?>">Próximo</a></li> 
                                    <?php }else{ ?>
