                                            ...
                                            <div>  
                                                ...
                                                <h3>Sessões</h3>
                                                    <div class="form-row">                                        
                                                        <div class="col">
                                                            <small>FR </small>
                                                            <input type="number" class="form-control" id="fr" name="fr" value="<?php echo $linha['quantidade_fr']; ?>">
                                                        </div>
                                                        <div class="col">
                                                            <small>FM </small>
                                                            <input type="number" class="form-control" id="fm" name="fm" value="<?php echo $linha['quantidade_fm']; ?>">
                                                        </div>    
                                                    </div>
                                            </div>
                                                <br>                                                        
