		...
		<div class="row justify-content-center">
			<div class="col-md-8">
				<h1 class="brand-heading">FISIORESPIRAR</h1>
                                        <form method="POST" action="recadastro.php">
                                            <div>  
                                                ...
                                                <div class="form-row">                                        
                                                    <div class="col">
                                                        ...
                                                        <input type="date" class="form-control" id="dataJust" name="dataJust" value="<?php echo $linha['data_envio_just_unimed']; ?>">
                                                    </div>
                                                    <div class="col">
                                                        <small>FR</small>
                                                        <input type="number" class="form-control" placeholder="FR" id="fr" name="fr" value="<?php echo $linha['quantidade_fr']; ?>">
                                                    </div>
                                                    <div class="col">
                                                        <small>FM</small>
                                                        <input type="number" class="form-control" placeholder="FM" id="fm" name="fm" value="<?php echo $linha['quantidade_fm']; ?>">
                                                    </div>
                                                    <div class="col">
                                                        <small>Avaliação</small>
                                                        <input type="date" class="form-control" id="dataAval" name="dataAval" value="<?php echo $linha['data_envio_aval_unimed']; ?>">
                                                    </div>
                                                </div>
                                                
                                                <br><br>
                                                 <h3>Entregue ao Faturamento</h3>
                                                 <h5>Justificativa</h5>
                                                <div class="form-row">                                        
                                                    <div class="col">
                                                        <small>Para: </small>
                                                        <input type="text" class="form-control" id="entregaJustPara" name="entregaJustPara" value="<?php echo $linha['ent_fat_just_para']; ?>">
                                                    </div>
                                                    <div class="col">
                                                        <small>Dia: </small>
                                                        <input type="date" class="form-control" id="entregaJustDia" name="entregaJustDia" value="<?php echo $linha['ent_fat_just_dia']; ?>">
                                                    </div>    
                                                </div>
                                                ...
                                                <h5>Avaliação</h5>
                                                 <div class="form-row">                                        
                                                    <div class="col">
                                                        <small>Para: </small>
                                                        <input type="text" class="form-control" id="entregaAvalPara" name="entregaAvalPara" value="<?php echo $linha['ent_fat_aval_para']; ?>">
                                                    </div>
                                                    <div class="col">
                                                        <small>Dia: </small>
                                                        <input type="date" class="form-control" id="entregaAvalDia" name="entregaAvalDia" value="<?php echo $linha['ent_fat_aval_dia']; ?>"">
                                                    </div>
                                                </div>
                                                <br><br>
                                                <div class="col">
                                                    <h5>Observação <h5>
                                                    <textarea rows="5" class="form-control" id="observacao" name="observacao"><?php echo $linha['observacao']; ?></textarea>
                                                </div>
                                                <br>                                                        
