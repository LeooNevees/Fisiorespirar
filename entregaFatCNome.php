        ...
        <div class="intro">
			...
			<div class="col-md-13">
                            ...
                            <div>
                                ...
                                <input type="text" id="pessoaResp" name="pessoaResp" value="<?php echo $v_nomePessoa; ?>" readonly="true">
                            </div>
                            <!-- PESSOA QUE IRÁ RECEBER -->
                                    ...
                                    <tbody>                                    
                                        <?php while($linha = mysqli_fetch_assoc($resultado)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="validarEntregaJustFat.php?registro=<?php echo $linha['registro']; ?>&nomePessoa=<?php echo $v_nomePessoa; ?>&entrega=hoje " class="btn btn-primary btn-sm">Hoje</a></td>
                                                <td><a href="validarEntregaJustFat.php?registro=<?php echo $linha['registro']; ?>&nomePessoa=<?php echo $v_nomePessoa; ?>&entrega=amanha " class="btn btn-primary btn-sm">Amanha</a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <?php while($linhaa = mysqli_fetch_assoc($resultadoo)){ ?>
                                            <tr>
                                                ...
                                                <td><a href="validarEntregaAvalFat.php?registro=<?php echo $linhaa['registro']; ?>&nomePessoa=<?php echo $v_nomePessoa; ?>&entrega=hoje " class="btn btn-primary btn-sm">Hoje</a></td>
                                                <td><a href="validarEntregaAvalFat.php?registro=<?php echo $linhaa['registro']; ?>&nomePessoa=<?php echo $v_nomePessoa; ?>&entrega=amanha " class="btn btn-primary btn-sm">Amanha</a></td>
                                             </tr>
                                        <?php } ?>
                                    </tbody>                                    
                                </table>
