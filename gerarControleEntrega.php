...
$dataEntrega = filter_input(INPUT_GET, 'dataEntrega', FILTER_SANITIZE_STRING);
$conexao = mysqli_connect('127.0.0.1', 'root', '', 'fisiorespirar');
$tabela = "SELECT registro, nome, ent_fat_just_para, date_format(`ent_fat_just_dia`, '%d/%m/%Y') as ent_fat_just_dia, observacao FROM controle WHERE ent_fat_just_dia = '$dataEntrega' ORDER BY nome ASC; ";
$resultado = mysqli_query($conexao, $tabela);
?>

<?php
//TABELA REFERENTE A AVALIAÇÃO
$dataEntregaa = filter_input(INPUT_GET, 'dataEntrega', FILTER_SANITIZE_STRING);
$tabelaa = "SELECT registro, nome, ent_fat_aval_para, date_format(`ent_fat_aval_dia`, '%d/%m/%Y') as ent_fat_aval_dia, observacao FROM controle WHERE ent_fat_aval_dia = '$dataEntregaa' ORDER BY nome ASC;";
			...
			<div class="col-md-13">
                            ...
                            <br><br><br><br>
                                <?php if(mysqli_num_rows($resultado) == 0 && mysqli_num_rows($resultadoo) == 0){ ?>
                                    <div class="alert alert-danger" role="alert">Não foi entregue nada neste dia!</div>
                                <?php } ?>
                                ...
                                <table class="table table-striped table-dark">
                                    <thead>
                                        ...
                                        <th scope="col">Ent Just Para: </th>
                                        <th scope="col">Ent Just Dia: </th>
                                    ...
                                    <tbody>
                                        <?php while($linha = mysqli_fetch_assoc($resultado)){ 
                                            //BUSCA DE OBSERVACAO INTERCAMBIO
                                            $reg = $linha['registro'];
                                            ...
                                            <tr>
                                                ...
                                                <!-- INICIO DA CONDICAO DA JUSTIFICATIVA PARA OBSERVACAO -->
                                                <?php if($busca_Obs = mysqli_fetch_assoc($result_obs)) { ?>
                                                <td><?php echo $busca_Obs['observacao']; ?></td>
                                                <?php }else{ ?>
                                                    <td><?php echo ''; ?></td>
                                                <?php } ?>
                                                <!-- FIM DA CONDIÇAO DA JUSTIFICATIVA PARA OBSERVACAO -->
                                            </tr>
                                        <?php } ?>
                                    </tbody>                                   
                                </table>
                                ...
                                <table class="table table-striped table-dark">
                                    <thead>
                                        ...
                                        <th scope="col">Registro: </th>
                                        <th scope="col">Nome: </th>
                                        <th scope="col">Ent Aval Para: </th>
                                        <th scope="col">Ent Aval Dia: </th>
                                    ...
                                    <tbody>
                                        <?php while($linhaa = mysqli_fetch_assoc($resultadoo)){ 
                                            $regi = $linhaa['registro'];
                                            $buscaObss = "SELECT * FROM controle WHERE registro = '$regi' AND (observacao LIKE '%ECONOMUS%' OR observacao LIKE '%FUNDACAO CESP%' OR observacao LIKE '%NEGADA%') ";
                                            $result_obss = mysqli_query($conexao, $buscaObss);
                                        ?>
                                            <tr>
                                                <td><?php echo $linhaa['registro']; ?></td>
                                                <td><?php echo $linhaa['nome']; ?></td>
                                                <td><?php echo $linhaa['ent_fat_aval_para']; ?></td>
                                                <td><?php echo $linhaa['ent_fat_aval_dia']; ?></td>
                                                <!-- INICIO DA CONDICAO DA AVALIACAO NEGADA PARA OBSERVACAO -->
                                                <?php if($busca_Obss = mysqli_fetch_assoc($result_obss)) { ?>
                                                <td><?php echo $busca_Obss['observacao']; ?></td>
                                                <?php }else{ ?>
                                                    <td><?php echo ''; ?></td>
                                                <?php } ?>
                                                <!-- FIM DA CONDICAO DA AVALIACAO NEGADA PARA OBSERVACAO -->
                                            </tr>
                                        <?php } ?>
                                    </tbody>                                    
                                </table>
                                ...
                                <a href="controleBeneficencia.php" class="btn btn-primary">Novo Relatório</a>
