<?php
$mesRelatorio = filter_input(INPUT_GET, 'mesRelatorio', FILTER_SANITIZE_STRING);
$anoRelatorio = filter_input(INPUT_GET, 'anoRelatorio', FILTER_SANITIZE_STRING);
$conexao = mysqli_connect('127.0.0.1', 'root', '', 'fisiorespirar');
$tabela = "SELECT registro, nome, quantidade_fr, quantidade_fm FROM controle WHERE MONTH(data_cadastro) = $mesRelatorio AND YEAR(data_cadastro) = $anoRelatorio AND particular = 'sim';  ";
...
<!-- Página -->
    <div class="intro">
			...
			<div class="col-md-13">
                            <h1 class="brand-heading">Particular</h1>
                            <br><br><br><br>
                            <?php if(mysqli_num_rows($resultado) == 0){ ?>
                                <div class="alert alert-danger" role="alert">Não possui atendimento neste mês!</div>
                            <?php }else{ ?>
                            ...
                            <?php } ?>
                                ...
                                <a href="controleParticular.html" class="btn btn-primary">Novo Relatório</a>
